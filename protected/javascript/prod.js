...
const I = {
  ...
  I.get().done(function(res){
   ...
   $.each(i, function(ke, en){
        ...
        //console.log(en._id);
        prod.innerHTML += '<div class="columnprod"><div class="contentprod"><h3>Producto</h3><img src="'+en.img+'" alt="'+en.categoria+' class="imagetable" height="300" width="300" ><div class=overlaytable><div class="texttable">'+producto1+'<br>Costo<br>$'+en.costo+'.00<br><a href="/protected/protected2.html?value='+en._id+'"><button class="b">Detalles</button></a><br><br><a href="/protected/protected3.html?var='+en._id+'"><button class="b">Agregar al carrito</button></a></div></div></div></div>';
